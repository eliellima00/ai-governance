...
export const OTHER_SAMPLE_PROJECTS: SolutionProject[] = [
  {
    id: 'conciliacao-bancaria-controladoria',
    name: 'Robô de Conciliação Bancária PIX / Extratos',
    glpiTicketId: 'CH-2026-1012',
    assetId: 'ATIVO-FIN-019',
    department: 'Controladoria & Finanças',
    businessResponsible: 'MARIANA VASCONCELOS',
    technicalResponsible: 'LUCAS PINTO (Controladoria)',
    status: 'Em Adequação',
    stage: 'Plano de Ação / Adequação',
    executivePriority: 'P1 - Alta Prioridade',
    isPriorityForManagement: true,
    notes: 'Aguardando validação do Cofre de Senhas (Vault) pela equipe de Segurança de TI para chaves de API dos bancos.',
    notificationStatus: 'E-mail diário com log de divergências contábeis gerado às 06:30',
    hasImpediment: true,
    impedimentDetails: 'Dependência de aprovação de perfil de serviço no ERP Senior pela TI Infra.',
    actionRequiredFromManagement: 'Cobrar priorização do chamado de infraestrutura TI-9831 com o Coordenador de Infra.',
    scheduledDate: '19/09/2026 09:00',
    scheduledSubject: 'Reunião de alinhamento com Coordenador de Infraestrutura TI para liberar permissões',
    createdAt: '04/07/2026 09:15',
    lastUpdated: '12/08/2026 11:20',
    registeredBy: 'MARCO ANTONIO BOZELLI GONZALEZ MORAES',
    groupEncargado: 'TI - Sistemas Corporativos & Governança',
    userGroup: 'Dir. Financeira > Controladoria',
    objective: 'Script em Python/Pandas que consolida extratos bancários de 5 bancos com o razão do ERP Senior para conciliação diária de recebíveis de clientes e sementes.',
    initialDoc: 'Executado localmente na máquina do analista via arquivo .bat. Salva relatórios de divergência em pasta da rede.',
    qrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://glpi.attosementes.com.br/front/computer.form.php?id=ATIVO-FIN-019',
    links: {
      githubRepo: 'https://github.com/grupoatto/conciliacao-pix'
    },
    initialScore: 24,
    initialRisk: 'CRITICO',
    dimensionsInitial: { seguranca: 12, lgpd: 4, operacional: 8 },
    criteria: [
      { id: 'c1', criterion: 'Utiliza dados confidenciais', evidence: 'Extratos bancários e saldos de contas da empresa', points: 5, dimension: 'Segurança' },
      { id: 'c2', criterion: 'Processo financeiro/fiscal/regulatório', evidence: 'Sim (Conciliação contábil oficial)', points: 5, dimension: 'Operacional' },
      { id: 'c3', criterion: 'Execução em máquina local isolada', evidence: 'Script Python sem servidor central', points: 4, dimension: 'Segurança' },
      { id: 'c4', criterion: 'Impacto alto em indisponibilidade', evidence: 'Atraso no fechamento financeiro', points: 4, dimension: 'Operacional' },
      { id: 'c5', criterion: 'Tratamento de dados pessoais (PIX CPF)', evidence: 'Identificação de pagadores pessoas físicas', points: 4, dimension: 'LGPD' },
      { id: 'c6', criterion: 'Documentação inexistente', evidence: 'Código sem documentação de regras contábeis', points: 2, dimension: 'Operacional' }
    ],
    actionPlan: [
      { id: 101, title: 'Migrar execução para Airflow / Servidor corporativo seguro de TI', responsible: 'TI Infra + Lucas', deadline: '20/08/2026', priority: 'Crítica', status: 'Em andamento', riskPointsImpact: 5, dimension: 'Segurança' },
      { id: 102, title: 'Criptografia de credenciais de acesso bancário via Vault', responsible: 'TI Segurança', deadline: '15/08/2026', priority: 'Crítica', status: 'Aguardando', riskPointsImpact: 5, dimension: 'Segurança' },
      { id: 103, title: 'Documentar regras de matching contábil no GLPI', responsible: 'Lucas + Mariana', deadline: '30/08/2026', priority: 'Alta', status: 'Concluído', completionDate: '08/08/2026', riskPointsImpact: 3, dimension: 'Operacional' },
      { id: 104, title: 'Subir código no GitHub corporativo grupoatto/conciliacao-pix', responsible: 'TI Dev', deadline: '10/08/2026', priority: 'Alta', status: 'Concluído', completionDate: '10/08/2026', riskPointsImpact: 3, dimension: 'Governança' }
    ],
    sheetsCatalog: [],
    technicalDoc: {
      version: '1.2.0',
      classification: 'Solução Setorial Crítica',
      frontend: 'Interface CLI / Streamlit interno',
      backend: 'Python 3.11, Pandas, OpenPyXL',
      database: 'Arquivos OFX e Base Senior Sapiens',
      integrations: 'Leitura de extratos bancários OFX e exportação de lote contábil',
      pdfGeneration: 'Relatório diário de conciliação em Excel/PDF',
      emailDispatch: 'Resumo diário para diretoria financeira',
      hosting: 'Servidor Interno de Aplicações TI (em migração)',
      environments: 'Dev / Produção',
      domain: 'financeiro.attosementes.com.br',
      aiAssistance: 'N/A',
      backupData: 'Repositório de rede com backup diário em storage corporativo',
      backupCode: 'GitHub grupoatto/conciliacao-pix',
      incidentHandling: 'Abertura de chamado na fila TI - Sistemas Financeiros',
      featureRollout: 'Testes com base espelho homologada',
      versionControl: 'Git',
      contingency: 'Conciliação manual tradicional via tela do ERP Senior',
      maturity: 'Em produção há 6 meses',
      personalDataSummary: 'CPFs e nomes de cooperados e produtores rurais',
      pdfStorageSummary: 'Armazenamento em volume seguro corporativo',
      legalBasis: 'Cumprimento de obrigação legal e contábil',
      confidentialDataSummary: 'Movimentações financeiras de alta confidencialidade',
      retentionPolicy: 'Retenção por 5 anos conforme legislação contábil/fiscal',
      logsSummary: 'Logs de execução com hashing dos extratos processados',
      accessControlSummary: 'Restrito aos usuários do grupo Controladoria',
      accountsSummary: 'Usuário de serviço dedicado no ERP',
      credentialsSummary: 'Secret Manager'
    }
  },
  {
    id: 'calculadora-germina-lab',
    name: 'Calculadora de Vigor e Germinação de Lotes',
    glpiTicketId: 'CH-2026-1188',
    assetId: 'ATIVO-LAB-008',
    department: 'P&D / Laboratório de Sementes',
    businessResponsible: 'DRA. CAMILA ROCHA',
    technicalResponsible: 'FERNANDO ALMEIDA (Agronomia)',
    status: 'Uso',
    stage: 'Sustentação',
    executivePriority: 'P2 - Média',
    isPriorityForManagement: false,
    notes: 'Macros estabilizadas. 3 analistas treinados. Plano futuro é migrar cálculo estatístico direto para tela nativa do Senior Sapiens no Q1/2027.',
    notificationStatus: 'Notificações via e-mail corporativo para alertas de vigor < 90%',
    hasImpediment: false,
    scheduledDate: '29/09/2026 15:30',
    scheduledSubject: 'Revisão semestral de acurácia dos laudos com coordenação de laboratório',
    createdAt: '15/07/2026 10:00',
    lastUpdated: '01/08/2026 14:00',
    registeredBy: 'MARCO ANTONIO BOZELLI GONZALEZ MORAES',
    groupEncargado: 'TI - Sistemas Corporativos & Governança',
    userGroup: 'Dir. Operações > Laboratório Qualidade',
    objective: 'Planilha avançada com macros VBA e AppSheet para coleta de dados de tetrazólio, emergência e vigor de lotes de sementes de soja.',
    initialDoc: 'Utilizado por 8 analistas de bancada em tablets no laboratório de Rondonópolis.',
    qrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://glpi.attosementes.com.br/front/computer.form.php?id=ATIVO-LAB-008',
    links: {
      spreadsheet: 'https://docs.google.com/spreadsheets/d/mock-lab-sementes'
    },
    initialScore: 14,
    initialRisk: 'ALTO',
    dimensionsInitial: { seguranca: 4, lgpd: 0, operacional: 10 },
    criteria: [
      { id: 'l1', criterion: 'Impacto operacional alto na qualidade do lote', evidence: 'Liberação de laudos de sementes', points: 4, dimension: 'Operacional' },
      { id: 'l2', criterion: 'Utiliza dados de sistemas industriais', evidence: 'Vinculação com código de lote do ERP', points: 3, dimension: 'Operacional' },
      { id: 'l3', criterion: 'Armazenamento em planilhas compartilhadas', evidence: 'Risco de sobreescrita de fórmulas', points: 3, dimension: 'Segurança' },
      { id: 'l4', criterion: 'Dependência de único desenvolvedor local', evidence: 'Fernando criou as macros', points: 2, dimension: 'Operacional' },
      { id: 'l5', criterion: 'Documentação inexistente', evidence: 'Sem manual de validação de fórmulas agronômicas', points: 2, dimension: 'Operacional' }
    ],
    actionPlan: [
      { id: 201, title: 'Travar fórmulas e proteger abas mestras da planilha', responsible: 'Fernando + TI', deadline: '25/07/2026', priority: 'Alta', status: 'Concluído', completionDate: '24/07/2026', riskPointsImpact: 3, dimension: 'Operacional' },
      { id: 202, title: 'Backup automático diário dos laudos em pasta corporativa', responsible: 'TI', deadline: '28/07/2026', priority: 'Alta', status: 'Concluído', completionDate: '26/07/2026', riskPointsImpact: 3, dimension: 'Operacional' },
      { id: 203, title: 'Homologar regras estatísticas com gerência de qualidade', responsible: 'Dra. Camila', deadline: '10/08/2026', priority: 'Média', status: 'Concluído', completionDate: '02/08/2026', riskPointsImpact: 2, dimension: 'Governança' },
      { id: 204, title: 'Avaliar incorporação definitiva no módulo de Qualidade do ERP', responsible: 'TI Sistemas', deadline: '30/11/2026', priority: 'Média', status: 'Aguardando', riskPointsImpact: 4, dimension: 'Operacional' }
    ],
    sheetsCatalog: [],
    technicalDoc: {
      version: '1.0.1',
      classification: 'Solução Departamental Operacional',
      frontend: 'AppSheet e interface Google Sheets',
      backend: 'Google Apps Script / Fórmulas estatísticas',
      database: 'Google Sheets Qualidade',
      integrations: 'Importação de lotes do ERP',
      pdfGeneration: 'Geração de Laudo Preliminar de Germinação',
      emailDispatch: 'Alerta de lotes abaixo de 90% de vigor',
      hosting: 'Google Workspace Corporativo',
      environments: 'Produção',
      domain: 'N/A',
      aiAssistance: 'N/A',
      backupData: 'Backup diário agendado',
      backupCode: 'Drive Institucional TI',
      incidentHandling: 'Fila GLPI Qualidade & P&D',
      featureRollout: 'Validação pelo responsável técnico agronômico',
      versionControl: 'Versionamento por histórico',
      contingency: 'Planilha física padrão MAPA',
      maturity: 'Estável',
      personalDataSummary: 'Não trata dados pessoais sensíveis',
      pdfStorageSummary: 'Drive corporativo',
      legalBasis: 'Controle de qualidade e conformidade com padrões MAPA',
      confidentialDataSummary: 'Índices genéticos e vigor de sementes ATTO',
      retentionPolicy: '5 anos',
      logsSummary: 'Histórico de edições do Google Sheets',
      accessControlSummary: 'Restrito a analistas de laboratório',
      accountsSummary: 'Contas do laboratório',
      credentialsSummary: 'Não utiliza chaves externas'
    }
  },
  {
  ...
  {
    id: 'automacao-cte-faturas-senior',
    name: 'Automação de CTe & Faturas de Frete (OCR)',
    glpiTicketId: 'CH-2026-1602',
    assetId: 'ATIVO-LOG-015',
    department: 'Logística / Fiscal',
    businessResponsible: 'ANDREIA SILVA (Adm Comercial)',
    technicalResponsible: 'TI - Sistemas Corporativos (Roger / Marcio)',
    status: 'Em Adequação',
    stage: 'Plano de Ação / Adequação',
    executivePriority: 'P1 - Alta Prioridade',
    isPriorityForManagement: true,
    notes: 'Leitura de XMLs e PDFs de fretes recebidos no e-mail corporativo, conferência de valores contra a cotação aprovada no Portal de Logística e pré-lançamento no ERP Senior.',
    notificationStatus: 'Alertas no canal Teams da Logística quando há divergência de valor > 1%',
    hasImpediment: false,
    scheduledDate: '24/09/2026 16:00',
    scheduledSubject: 'Apresentação do piloto de OCR com 5 transportadoras para a gerência fiscal',
    createdAt: '01/08/2026 11:30',
    lastUpdated: '15/08/2026 15:45',
    registeredBy: 'MARCO ANTONIO BOZELLI GONZALEZ MORAES',
    groupEncargado: 'TI - Sistemas Corporativos & Governança',
    userGroup: 'Dir. Comercial > Adm. Comercial',
    objective: 'Reduzir tempo de digitação de CT-es e faturas de frete no ERP, evitando pagamentos divergentes.',
    initialDoc: 'Script Python com OCR Tesseract e integração com API do Senior Sapiens.',
    qrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://glpi.attosementes.com.br/front/computer.form.php?id=ATIVO-LOG-015',
    links: {
      githubRepo: 'https://github.com/grupoatto/automacao-cte-senior'
    },
    initialScore: 22,
    initialRisk: 'CRITICO',
    dimensionsInitial: { seguranca: 10, lgpd: 4, operacional: 8 },
    criteria: [
      { id: 'cte1', criterion: 'Lançamento financeiro e fiscal automatizado', evidence: 'Gera pré-títulos a pagar no ERP Senior', points: 5, dimension: 'Operacional' },
      { id: 'cte2', criterion: 'Acesso a credenciais de faturamento ERP', evidence: 'Token de integração com permissões fiscais', points: 4, dimension: 'Segurança' }
    ],
    actionPlan: [
      { id: 401, title: 'Limitar escopo do token de API apenas para pré-digitação (sem autorizar pagamento)', responsible: 'TI Sistemas', deadline: '20/08/2026', priority: 'Crítica', status: 'Concluído', completionDate: '12/08/2026', riskPointsImpact: 4, dimension: 'Segurança' },
      { id: 402, title: 'Criar alçada de aprovação humana para divergências superiores a R$ 50,00', responsible: 'Andreia + TI', deadline: '28/08/2026', priority: 'Alta', status: 'Em andamento', riskPointsImpact: 3, dimension: 'Operacional' }
    ],
    sheetsCatalog: [],
    technicalDoc: {
      version: '0.9.2',
      classification: 'Automação Fiscal & Logística',
      frontend: 'Painel Web de Conferência de Divergências',
      backend: 'Python 3.11 / FastAPI',
      database: 'PostgreSQL Corporativo',
      integrations: 'ERP Senior Sapiens, Sefaz (Consulta CTe) e Portal Logística',
      pdfGeneration: 'Relatório de divergências em PDF',
      emailDispatch: 'Notificações de divergência para transportadora e operador',
      hosting: 'Servidor Interno TI',
      environments: 'Homologação',
      domain: 'cte.attosementes.com.br',
      aiAssistance: 'OCR com IA para extração de tabelas de faturas não-padronizadas',
      backupData: 'Backup diário corporativo',
      backupCode: 'GitHub grupoatto/automacao-cte-senior',
      incidentHandling: 'Fila GLPI TI Fiscal',
      featureRollout: 'Fase de validação com 5 transportadoras piloto',
      versionControl: 'Git',
      contingency: 'Entrada manual tradicional no ERP Senior',
      maturity: 'Piloto em validação',
      personalDataSummary: 'Dados fiscais de transportadores autônomos (CPF e placa)',
      pdfStorageSummary: 'Repositório seguro de documentos fiscais',
      legalBasis: 'Cumprimento de obrigação fiscal e execução contratual',
      confidentialDataSummary: 'Tabelas de preços e faturas comerciais de frete',
      retentionPolicy: '5 anos para documentos fiscais',
      logsSummary: 'Log completo de auditoria por número de chave CT-e',
      accessControlSummary: 'Restrito aos operadores fiscais e logística',
      accountsSummary: 'Usuário de integração fiscal dedicado',
      credentialsSummary: 'Vault de senhas corporativo'
    }
  },
  {
    id: 'portal-produtor-cooperado',
    name: 'Portal do Cooperado & Consulta de Pedidos de Sementes',
    glpiTicketId: 'CH-2026-1720',
    assetId: 'ATIVO-MKT-007',
    department: 'Comercial & Marketing',
    businessResponsible: 'RODRIGO MENDES (Gerente Comercial)',
    technicalResponsible: 'TI - Soluções Web',
    status: 'Em Adequação',
    stage: 'Levantamento & Ficha',
    executivePriority: 'P2 - Média',
    isPriorityForManagement: false,
    notes: 'Interface web responsiva para produtores rurais consultarem status de faturamento de sementes, previsão de entrega na fazenda e 2ª via de boletos.',
    notificationStatus: 'Disparo de SMS e e-mail transacional a cada avanço no status do pedido',
    hasImpediment: true,
    impedimentDetails: 'Falta definição da gerência comercial sobre o escopo mínimo de campos visíveis para os cooperados e regra de liberação de boletos.',
    actionRequiredFromManagement: 'Alinhar com Rodrigo Mendes o escopo congelado do MVP na próxima reunião de diretoria comercial.',
    scheduledDate: '25/09/2026 11:00',
    scheduledSubject: 'Reunião de definição de escopo MVP com gerência comercial',
    createdAt: '05/08/2026 15:00',
    lastUpdated: '12/08/2026 09:30',
    registeredBy: 'MARCO ANTONIO BOZELLI GONZALEZ MORAES',
    groupEncargado: 'TI - Sistemas Corporativos & Governança',
    userGroup: 'Dir. Comercial > Vendas',
    objective: 'Proporcionar autosserviço aos cooperados para acompanhamento de pedidos de sementes e entregas.',
    initialDoc: 'Documento preliminar de requisitos no Confluence/GLPI.',
    qrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://glpi.attosementes.com.br/front/computer.form.php?id=ATIVO-MKT-007',
    links: {},
    initialScore: 18,
    initialRisk: 'ALTO',
    dimensionsInitial: { seguranca: 8, lgpd: 6, operacional: 4 },
    criteria: [
      { id: 'p1', criterion: 'Acesso externo para produtores rurais', evidence: 'Portal web exposto na internet', points: 4, dimension: 'Segurança' },
      { id: 'p2', criterion: 'Tratamento de dados de clientes e contratos', evidence: 'Valores de compras de sementes, CPF e dados bancários', points: 4, dimension: 'LGPD' }
    ],
    actionPlan: [
      { id: 501, title: 'Definir arquitetura segura com WAF e autenticação OTP/SMS', responsible: 'TI Segurança', deadline: '30/09/2026', priority: 'Alta', status: 'Aguardando', riskPointsImpact: 4, dimension: 'Segurança' }
    ],
    sheetsCatalog: [],
    technicalDoc: {
      version: '0.1.0',
      classification: 'Portal de Clientes & Cooperados',
      frontend: 'React / Next.js',
      backend: 'Node.js / GraphQL',
      database: 'PostgreSQL + Cache Redis',
      integrations: 'ERP Senior e CRM Salesforce',
      pdfGeneration: 'Download de espelho de pedido e 2ª via de boleto',
      emailDispatch: 'E-mails transacionais via Sendgrid',
      hosting: 'AWS / Cloudflare',
      environments: 'Desenvolvimento',
      domain: 'cooperado.attosementes.com.br',
      aiAssistance: 'Chatbot de autoatendimento para dúvidas frequentes',
      backupData: 'Backup diário automatizado',
      backupCode: 'GitHub grupoatto/portal-cooperado',
      incidentHandling: 'Fila GLPI Suporte ao Cliente',
      featureRollout: 'Fase de especificação funcional',
      versionControl: 'Git',
      contingency: 'Atendimento telefônico via RTVs e representantes',
      maturity: 'Planejamento / Levantamento',
      personalDataSummary: 'CPF, CNPJ, dados de propriedade rural e telefones',
      pdfStorageSummary: 'Bucket S3 restrito',
      legalBasis: 'Execução de contrato comercial',
      confidentialDataSummary: 'Histórico de compras e condições comerciais negociadas',
      retentionPolicy: '5 anos',
      logsSummary: 'Trilha de auditoria de acessos e downloads de boletos',
      accessControlSummary: 'Autenticação com CPF/CNPJ + OTP via SMS',
      accountsSummary: 'Usuários externos vinculados ao cadastro do ERP',
      credentialsSummary: 'AWS Secrets Manager'
    }
  }
];
