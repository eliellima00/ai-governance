...
> = {
  A: {
    ...
    shortDesc:
      "Planilhas Google, formulários, automações Apps Script e portais Google Apps.",
    technologyHint: "Apps Script, Google Sheets, Google Drive, Google Forms",
  },
  B: {
    label: "Container / VPS / Backend",
    shortDesc:
      "Aplicações web, Docker, Node.js, Python, PostgreSQL/MySQL, AWS/Cloudflare ou VPS.",
    technologyHint:
      "Docker, VPS, Node/React, Python, Fastify, Next.js, Banco de dados dedicado",
  },
  C: {
    label: "No-Code / Plataformas Externas",
    shortDesc:
      "Plataformas como Blip, n8n, Zapier, Make, Bubble ou soluções SaaS proprietárias.",
    technologyHint: "Blip, n8n, Make, Zapier, Bubble, Power Apps",
    statusBadge: "A calibrar (Base Workspace)",
  },
};

export const GOV_STAGES_CATALOG: GovStage[] = [
  "E0",
  "E1",
  "E2",
  "E3",
...
export const STAGE_DESCRIPTIONS: Record<GovStage, string> = {
  ...
  E6: "Documentação de entregas e encerramento.",
  Concluído:
    "Esteira técnica de governança 100% finalizada e homologada pela T.I.",
};

// Base hours and meeting/external dependency flags per Stage
export const STAGES_BASE_CONFIG: Record<
  ProjectType,
  Record<GovStage, { hours: number; meetings: number; externalDeps: number }>
> = {
  A: {
...
export const MODULES_CATALOG: ModuleDefinition[] = [
  {
    id: "M1",
    label:
      "Ambiente dev do mantenedor (WSL/Ubuntu/Git/VSCode/Claude Code) + avaliação",
    hours: 3.25,
    stageId: "E5",
    meetings: 1,
    externalDeps: 0,
    description:
      "Padronização do ambiente local de desenvolvimento e testes do mantenedor com T.I.",
  },
  {
    id: "M2",
    ...
    externalDeps: 1,
    description:
      "Avaliação de DNS, subdomínio institucional, WAF ou tuneis Cloudflare/AWS.",
  },
  {
    id: "M3",
    label:
      "Integração adicional a mapear (RD Station, ERP Senior, API externa)",
    hours: 1.0,
    stageId: "E1",
    meetings: 0,
    externalDeps: 0,
    description:
      "Levantamento de payloads, endpoints e credenciais de integração com terceiros.",
  },
  {
    id: "M4",
    ...
    externalDeps: 0,
    description:
      "Saneamento e transferência segura de bases históricas e conformidade de guarda.",
  },
  {
    id: "M5",
    label:
      "Provisionar conta corporativa paga (OpenAI, Codex, Claude, licenças)",
    hours: 0.5,
    stageId: "E3",
    meetings: 0,
    externalDeps: 1,
    description:
      "Abertura de chamado de faturamento corporativo para desvincular cartão pessoal.",
  },
  {
    id: "M6",
    ...
    externalDeps: 1,
    description:
      "Alinhamento com equipe de Cloud / Infraestrutura da T.I para provisionamento.",
  },
];
...
export const DISCOUNTS_CATALOG: DiscountDefinition[] = [
  {
    ...
    stageId: "E5",
    description:
      "Repositório GitHub oficial configurado com permissões corporativas.",
  },
  {
    id: "D2",
    ...
    stageId: "E4",
    description:
      "Rotina de salvamento testada com evidência de recuperação operacional.",
  },
  {
    id: "D3",
    ...
    stageId: "E2",
    description:
      "Ficha preliminar de contatos, links e inventário já preenchidos.",
  },
  {
    id: "D4",
    ...
    stageId: "E3",
    description:
      "Nenhum e-mail ou cartão de crédito pessoal associado à solução.",
  },
];
...
export const EXIT_CRITERIA_CHECKLIST = [
  {
    ...
    description:
      "Todas as pendências e vulnerabilidades críticas mapeadas na E1 e E3 foram remediadas.",
  },
  {
    id: "crit-2",
    title: "2. Backup + restore testado",
    description:
      "Rotina de salvamento independente ativa e evidência de teste de restauração validada pela T.I.",
  },
  {
    id: "crit-3",
    title: "3. Fora da mão de uma só pessoa",
    description:
      "Desenvolvedor secundário treinado, ponto focal da T.I nomeado, conta ti.dev@attosementes.com.br com acesso total e T.I habilitada a realizar deploy.",
  },
  {
    id: "crit-4",
    title: "4. Documentação mínima de localização e contato",
    description:
      "Ficha cadastral viva atualizada no GLPI com repositório, contatos, POP de emergência e canais de acionamento.",
  },
];
